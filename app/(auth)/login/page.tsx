    ...
    return (
        <div className="auth-animate absolute inset-0 overflow-hidden pointer-events-none" style={{ animation: "auth-bg-fade 0.8s ease-out" }}>
            ...
            <div className="hidden md:block">
                {/* Card 1 — top left */}
                <div
                    className="absolute top-[18%] left-[8%] w-36 h-24 rounded-xl border border-zinc-800/40 bg-zinc-900/30 backdrop-blur-sm p-3 opacity-[0.35]"
                ...
                {/* Card 2 — top right */}
                <div
                    className="absolute top-[12%] right-[10%] w-32 h-20 rounded-xl border border-zinc-800/40 bg-zinc-900/30 backdrop-blur-sm p-3 opacity-[0.25]"
                    style={{ animation: "auth-float-reverse 10s ease-in-out infinite 1s" }}
                >
                    <div className="flex items-center gap-2 mb-2">
                ...
                {/* Card 3 — bottom left */}
                <div
                    className="absolute bottom-[20%] left-[12%] w-28 h-20 rounded-xl border border-zinc-800/40 bg-zinc-900/30 backdrop-blur-sm p-3 opacity-[0.2]"
                    style={{ animation: "auth-float-reverse 9s ease-in-out infinite 2s" }}
                >
                    <div className="flex items-center gap-2 mb-2">
                ...
                {/* Card 4 — bottom right */}
                <div
                    className="absolute bottom-[15%] right-[8%] w-36 h-24 rounded-xl border border-zinc-800/40 bg-zinc-900/30 backdrop-blur-sm p-3 opacity-[0.3]"
                    style={{ animation: "auth-float 11s ease-in-out infinite 3s" }}
                >
                    <div className="flex items-center gap-2 mb-2">
                        <FileText className="w-3.5 h-3.5 text-blue-500/60" />
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div
                        ...
                        style={{ animation: "auth-orbit 25s linear infinite" }}
                    />
                </div>
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2">
                    <div
                        className="w-1.5 h-1.5 rounded-full bg-violet-500/15"
                        style={{ animation: "auth-orbit 35s linear infinite reverse" }}
                    />
                </div>
            ...
            >
                ...
                <div className="text-center mb-8">
                    <Link href="/" className="inline-flex items-center justify-center gap-2.5 mb-6 group">
                        <div className="w-11 h-11 rounded-xl bg-gradient-to-br from-blue-500 to-violet-600 flex items-center justify-center shadow-lg shadow-blue-500/25 group-hover:shadow-blue-500/40 transition-shadow">
                            <Brain className="w-6 h-6 text-white" />
                        </div>
                        <span className="text-xl font-bold text-white tracking-tight">
                            Memora<span className="bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-violet-400">AI</span>
                        </span>
                    </Link>
                    <h1
                    ...
                    >
                        Sign in to your AI-powered knowledge base
                    </p>
                </div>
                ...
                <div
                    ...
                    style={{
                        boxShadow: "0 0 0 1px rgba(139,92,246,0.05), 0 25px 50px -12px rgba(0,0,0,0.5), 0 0 80px rgba(99,102,241,0.03)",
                    }}
                >
                        ...
                        >
                            ...
                            <input
                                ...
                                className="w-full px-4 py-3 rounded-xl bg-zinc-800/40 border border-zinc-700/40 text-zinc-100
                                    ...
                                    focus:outline-none focus:border-blue-500/50 focus:ring-2 focus:ring-blue-500/20 focus:bg-zinc-800/60
                        ...
                        >
                            <button
                                ...
                                className="w-full py-3 px-6 rounded-xl font-semibold text-sm text-white
                                    ...
                                    hover:shadow-xl hover:shadow-blue-500/30 hover:from-blue-400 hover:to-violet-500
                                    active:scale-[0.98]
                    ...
                    >
                        ...
                        <Link
                            href="/register"
                            className="font-medium text-blue-400 hover:text-blue-300 transition-colors relative
                                after:absolute after:bottom-0 after:left-0 after:w-0 after:h-px after:bg-blue-400
